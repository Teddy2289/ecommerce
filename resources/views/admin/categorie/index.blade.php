            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        <h4>Categories</h4>
                        <p class="mb-0">Tout nos liste de categories</p>
                    </div>
                </div>
                <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                    <ol class="breadcrumb">
                        <a href="{{route('add_categorie')}}" class="btn btn-rounded btn-info"><span class="btn-icon-left text-info"><i class="fa fa-plus color-info"></i></span>Add</a>
                    </ol>
                </div>
            </div>
            <div class="card">
                    ...
                    <div class="table-responsive">
                        <table class="table header-border table-responsive-sm">
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge badge-success"> {{$row->popular}}</span>
                                </td>
                                <td >
                                    <span class="badge badge-success"> {{$row->status}}</span>
                                <td> {{$row->meta_title}}</td>
                                <td> {{$row->meta_descri}}</td>
                                <td> {{$row->meta_keyword}}</td>
                                <td>
                                    <img src="{{asset('uploads/'.$row->image)}}" alt="" style="width: 100px;">
                                </td>
                                <td style="width: 140px ! important;"><span><a href="{{route('edit_cat',$row->id)}}" class="btn btn-outline-primary"   data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-pencil color-muted"></i> </a>
